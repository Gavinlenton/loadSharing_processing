...
subjectDir = uigetdir('P8', 'Select the folder that contains the current subject data');
...
[genericSetupForIK,genericSetupPath,FilterIndex] = ...
    uigetfile('*.xml','Pick the a generic setup file for this subject/model as a basis for changes.');
...
for trial= 1:nTrials;
    ...
    name = regexprep(markerFile,'Phys.trc','');
    ...
    ikTool.setOutputMotionFileName([results_folder '\' name 'Phys_ik.mot']);
