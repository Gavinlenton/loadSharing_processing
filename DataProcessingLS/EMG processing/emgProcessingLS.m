function [] = emgProcessingLS(isNotch, sessionData, timePoints, sessionName, isMax)
...
%     analogData = contentMaxDir(s).name(1:end-5);
%     analogData = char(dynamicFolders{s});
suffix = 'AnalogData.mat';
emgFile1 = fullfile(analogData, suffix);
%     filename2 = [analogData, 'b', suffix];
%     emgFile2 = fullfile(maxDir, filename2);
%     filename3 = [analogData, 'c', suffix];
