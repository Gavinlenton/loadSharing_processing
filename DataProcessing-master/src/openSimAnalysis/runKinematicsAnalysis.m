function [KinematicsoutputDir, KinematicstrialsOutputDir]=runKinematicsAnalysis(inputDir,inputTrials, model_file, IKmotDir, KAid, KATemplateXml, fcut_coordinates, varargin)
