function [KAid, XMLsetupTemplate, fcut_coordinates, inputTrials, IKresultsDir, varargout] = KAinput(trialsList, varargin)
...
dialogText = 'Select a processing identifier for the Kinematics Analysis';
KAid = char(inputdlg(sprintf(dialogText)));
...
if nargout>3
    ...
    %Get folder with Inverse Kinematics results to use for KA
    if nargout == 5           
